...
class COCODataset:
    ...
    def __init__(self, root, txt,
        ...
        if is_test:
            image_sets_file = self.txt + "test.txt"
        else:
            if is_validate:
                image_sets_file = self.txt + "val.txt"
            else:
                image_sets_file = self.txt + "train.txt"
    ...
    def _get_annotation(self, image_id):
        annotation_file = self.root + "annotations/instances_val2014.json"
    ...
    def _read_image(self, image_id):
        image_file = self.root + "val2014/%s.jpg" %image_id
