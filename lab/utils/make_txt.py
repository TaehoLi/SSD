...
def make_txt(how_many_image, txt_folder, annotations):
    total_file = 40000
    test = 0.1
    validation = 0.2
    ...
    with open((annotations + 'instances_val2014.json'), encoding="utf-8") as data_file:
