...
class NEUDataset:
    ...
    def _read_image(self, image_id):
        ...
        a = image_id.find("cropped")
        if a is not -1:
            image_file = self.root / f"IMAGES_cropped/{image_id}.jpg"
